...
describe("provider discovery contract", () => {
  beforeEach(async () => {
    vi.resetModules();
    vi.doMock("maumau/plugin-sdk/agent-runtime", async () => {
    ...
    vi.doMock("maumau/plugin-sdk/provider-auth", async () => {
      const actual = await vi.importActual<object>("maumau/plugin-sdk/provider-auth");
      return {
        ...actual,
        ensureAuthProfileStore: ensureAuthProfileStoreMock,
        listProfilesForProvider: listProfilesForProviderMock,
    ...
    vi.doMock("maumau/plugin-sdk/provider-setup", async () => {
      const actual = await vi.importActual<object>("maumau/plugin-sdk/provider-setup");
      return {
        ...actual,
    ...
    vi.doMock("maumau/plugin-sdk/self-hosted-provider-setup", async () => {
      const actual = await vi.importActual<object>("maumau/plugin-sdk/self-hosted-provider-setup");
      return {
        ...actual,
        buildVllmProvider: (...args: unknown[]) => buildVllmProviderMock(...args),
        buildSglangProvider: (...args: unknown[]) => buildSglangProviderMock(...args),
    ...
    vi.doMock("maumau/plugin-sdk/ollama-setup", async () => {
      const actual = await vi.importActual<object>("maumau/plugin-sdk/ollama-setup");
      return {
        ...actual,
        buildOllamaProvider: (...args: unknown[]) => buildOllamaProviderMock(...args),
      };
