...
import { loadConfig, type MaumauConfig } from "maumau/plugin-sdk/config-runtime";
...
import { maxBytesForKind } from "maumau/plugin-sdk/media-runtime";
import { extensionForMime } from "maumau/plugin-sdk/media-runtime";
import { unlinkIfExists } from "maumau/plugin-sdk/media-runtime";
import type { PollInput } from "maumau/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "maumau/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredMaumauTmpDir();
