...
import type { MaumauConfig, SlackReactionNotificationMode } from "maumau/plugin-sdk/config-runtime";
import { resolveSessionKey, type SessionScope } from "maumau/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "maumau/plugin-sdk/config-runtime";
import { createDedupeCache } from "maumau/plugin-sdk/infra-runtime";
import type { HistoryEntry } from "maumau/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("maumau/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
