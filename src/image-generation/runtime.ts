...
function buildNoImageGenerationModelConfiguredMessage(cfg: MaumauConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: MaumauConfig }) {
