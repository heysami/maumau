...
read_when:
  - You want Zalo Personal (unofficial) support in Maumau
...
Zalo Personal support for Maumau via a plugin, using native `zca-js` to automate a normal Zalo user account.
