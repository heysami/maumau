...
export function hasAmbiguousGatewayAuthModeConfig(cfg: MaumauConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: MaumauConfig): void {
