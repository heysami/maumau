...
import type { MaumauPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = MaumauPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("maumau.pluginCommandsState");
