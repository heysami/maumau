...
const (
	envDocsPiExecutable     = "MAUMAU_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "MAUMAU_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "MAUMAU_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "maumau", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
