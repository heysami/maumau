...
describe("gateway auth", () => {
  ...
  it("resolves token/password from MAUMAU gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          MAUMAU_GATEWAY_TOKEN: "env-token",
          MAUMAU_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides MAUMAU_GATEWAY_PASSWORD", () => {
