...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<MaumauConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<MaumauConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: MaumauConfig): WebSearchConfig {
