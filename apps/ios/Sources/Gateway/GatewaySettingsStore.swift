...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.maumau.gateway"
    private static let nodeService = "ai.maumau.node"
    private static let talkService = "ai.maumau.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.maumau.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.maumau.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("maumau-gateway.log")
    }
