...
import { listCombinedAccountIds } from "maumau/plugin-sdk/account-resolution";
...
export function listDiscordSetupAccountIds(cfg: MaumauConfig): string[] {
...
export function resolveDefaultDiscordSetupAccountId(cfg: MaumauConfig): string {
