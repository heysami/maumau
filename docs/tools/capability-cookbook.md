---
summary: "Contributor guide for adding a new shared capability to the Maumau plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for Maumau core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when Maumau needs a new domain such as image generation, video
