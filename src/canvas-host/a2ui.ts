...
export const A2UI_PATH = "/__maumau__/a2ui";

export const CANVAS_HOST_PATH = "/__maumau__/canvas";

export const CANVAS_WS_PATH = "/__maumau__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.maumauCanvasA2UIAction.postMessage(...)
  // - Android: window.maumauCanvasA2UIAction.postMessage(...)
  const handlerNames = ["maumauCanvasA2UIAction"];
  ...
  globalThis.Maumau = globalThis.Maumau ?? {};
  globalThis.Maumau.postMessage = postToNode;
  globalThis.Maumau.sendUserAction = sendUserAction;
  globalThis.maumauPostMessage = postToNode;
  globalThis.maumauSendUserAction = sendUserAction;
