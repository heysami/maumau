---
summary: "Use Qianfan's unified API to access many models in Maumau"
read_when:
...
3. Maumau installed on your system
...
4. Copy the API key for use with Maumau

## CLI setup

```bash
maumau onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Maumau Configuration](/gateway/configuration)
