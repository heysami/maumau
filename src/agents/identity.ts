import type { MaumauConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityNamePrefix(cfg: MaumauConfig, agentId: string): string | undefined {
...
export function resolveIdentityName(cfg: MaumauConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[maumau]";
}

/** Helper to extract a channel config value by dynamic key. */
function getChannelConfig(cfg: MaumauConfig, channel: string): Record<string, unknown> | undefined {
