...
const CLEANUP_STATE_KEY = Symbol.for("maumau.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("maumau.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("maumau.sessionWriteLockWatchdogState");
