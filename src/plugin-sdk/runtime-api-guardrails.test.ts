...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/googlechat/runtime-api.ts": ['export * from "maumau/plugin-sdk/googlechat";'],
  "extensions/matrix/runtime-api.ts": [
    'export * from "./src/auth-precedence.js";',
    'export * from "./helper-api.js";',
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "maumau/plugin-sdk/ssrf-runtime";',
    ...
    'export { writeJsonFileAtomically } from "maumau/plugin-sdk/json-store";',
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, MaumauConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "maumau/plugin-sdk/matrix";',
    'export { formatZonedTimestamp } from "maumau/plugin-sdk/matrix";',
  ],
  "extensions/nextcloud-talk/runtime-api.ts": ['export * from "maumau/plugin-sdk/nextcloud-talk";'],
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, MaumauConfig, MaumauPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramNetworkConfig } from "maumau/plugin-sdk/telegram";',
    'export type { TelegramApiOverride } from "./src/send.js";',
    'export type { MaumauPluginService, MaumauPluginServiceContext, PluginLogger } from "maumau/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "maumau/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "maumau/plugin-sdk/acp-runtime";',
    'export { buildTokenChannelStatusSummary, clearAccountEntryFields, DEFAULT_ACCOUNT_ID, normalizeAccountId, PAIRING_APPROVED_MESSAGE, parseTelegramTopicConversation, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses, resolveTelegramPollVisibility } from "maumau/plugin-sdk/telegram";',
    'export { buildChannelConfigSchema, getChatChannelMeta, jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections, TelegramConfigSchema } from "maumau/plugin-sdk/telegram-core";',
