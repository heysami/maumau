...
} from "maumau/plugin-sdk/command-auth";
import {
...
import type { MaumauConfig, loadConfig } from "maumau/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "maumau/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "maumau/plugin-sdk/config-runtime";
...
import { executePluginCommand, matchPluginCommand } from "maumau/plugin-sdk/plugin-runtime";
import {
...
import { dispatchReplyWithDispatcher } from "maumau/plugin-sdk/reply-runtime";
...
import { loadWebMedia } from "maumau/plugin-sdk/web-media";
...
type DiscordConfig = NonNullable<MaumauConfig["channels"]>["discord"];
