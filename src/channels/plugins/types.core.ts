...
export type ChannelAgentToolFactory = (params: { cfg?: MaumauConfig }) => ChannelAgentTool[];
...
export type ChannelMessagingAdapter = {
  ...
  enableInteractiveReplies?: (params: { cfg: MaumauConfig; accountId?: string | null }) => boolean;
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: MaumauConfig; accountId?: string | null }) => string[];
};
