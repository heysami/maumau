...
function resolvePostCompactionIndexSyncMode(config?: MaumauConfig): "off" | "async" | "await" {
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureMaumauModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createMaumauCodingTools({
      exec: {
