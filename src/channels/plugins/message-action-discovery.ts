...
export function listChannelMessageActions(cfg: MaumauConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: MaumauConfig): ChannelMessageCapability[] {
