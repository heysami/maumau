...
vi.mock("maumau/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("maumau/plugin-sdk/web-media").loadWebMedia;
...
beforeAll(async () => {
  ...
  ({ loadWebMedia } = await import("maumau/plugin-sdk/web-media"));
