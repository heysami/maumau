    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["maumau channels list", "List configured channels and auth profiles."],
          ["maumau channels status --probe", "Run channel status checks and probes."],
          [
            "maumau channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["maumau channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.maumau.ai/cli/channels",
        )}\n`,
    );
