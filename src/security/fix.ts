...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof MaumauConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: MaumauConfig; env: NodeJS.ProcessEnv }): {
  cfg: MaumauConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
