...
export function scanLegacyToolsBySenderKeys(cfg: MaumauConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: MaumauConfig): {
  config: MaumauConfig;
  changes: string[];
} {
