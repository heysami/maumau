...
export BUNDLE_ID="${BUNDLE_ID:-ai.maumau.mac}"
...
ZIP="$ROOT_DIR/dist/Maumau-$VERSION.zip"
DMG="$ROOT_DIR/dist/Maumau-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Maumau-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Maumau-$VERSION.dSYM.zip"
