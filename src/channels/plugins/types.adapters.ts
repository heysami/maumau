...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: MaumauConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: MaumauConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: MaumauConfig) => string;
  setAccountEnabled?: (params: {
    cfg: MaumauConfig;
    accountId: string;
    enabled: boolean;
  }) => MaumauConfig;
  deleteAccount?: (params: { cfg: MaumauConfig; accountId: string }) => MaumauConfig;
  isEnabled?: (account: ResolvedAccount, cfg: MaumauConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: MaumauConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: MaumauConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: MaumauConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: MaumauConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.maumau.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: MaumauConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: MaumauConfig;
    nextCfg: MaumauConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: MaumauConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: MaumauConfig; accountId?: string | null }) =>
    | {
