...
import type { SessionBindingRecord } from "maumau/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "maumau/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "maumau/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<typeof import("maumau/plugin-sdk/config-runtime").loadConfig>;
export type RuntimeEnv = import("maumau/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("maumau/plugin-sdk/config-runtime").MaumauConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
