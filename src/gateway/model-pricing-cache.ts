...
export function collectConfiguredModelPricingRefs(config: MaumauConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: MaumauConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
