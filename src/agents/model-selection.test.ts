...
function resolveAnthropicOpusThinking(cfg: MaumauConfig) {
...
function createProviderWithModelsConfig(provider: string, models: Array<Record<string, unknown>>) {
  ...
  } as Partial<MaumauConfig>;
}

function resolveConfiguredRefForTest(cfg: Partial<MaumauConfig>) {
...
describe("model-selection", () => {
  ...
  describe("buildModelAliasIndex", () => {
    it("should build alias index from config", () => {
      const cfg: Partial<MaumauConfig> = {
        agents: {
          defaults: {
            models: {
