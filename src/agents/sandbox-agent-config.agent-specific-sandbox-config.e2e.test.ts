...
async function resolveContext(config: MaumauConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): MaumauConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
