...
- Keep product names in English: Maumau, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Maumau Gateway, use “Gateway 网关”.
