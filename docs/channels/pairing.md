...
read_when:
  ...
  - Reviewing Maumau security posture
title: "Pairing"
---

# Pairing

“Pairing” is Maumau’s explicit **owner approval** step.
...
Stored under `~/.maumau/credentials/`:
...
3. On your phone, open the Maumau iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `maumau nodes pending/approve`) is a
