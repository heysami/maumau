  ...
  return withEnvAsync(
    {
      ...
      MAUMAU_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when MAUMAU_VERSION is not set", async () => {
  ...
  it("prefers MAUMAU_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over MAUMAU_SERVICE_VERSION when MAUMAU_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        MAUMAU_VERSION: " ",
        MAUMAU_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when MAUMAU_VERSION and MAUMAU_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        MAUMAU_VERSION: " ",
        MAUMAU_SERVICE_VERSION: "\t",
