      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["maumau gateway run", "Run the gateway in the foreground."],
            ["maumau gateway status", "Show service status and probe reachability."],
            ["maumau gateway discover", "Find local and wide-area gateway beacons."],
            ["maumau gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.maumau.ai/cli/gateway")}\n`,
      ),
  );
