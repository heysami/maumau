...
export DISPLAY=:1
export HOME=/tmp/maumau-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${MAUMAU_BROWSER_CDP_PORT:-9222}"
CDP_SOURCE_RANGE="${MAUMAU_BROWSER_CDP_SOURCE_RANGE:-}"
VNC_PORT="${MAUMAU_BROWSER_VNC_PORT:-5900}"
NOVNC_PORT="${MAUMAU_BROWSER_NOVNC_PORT:-6080}"
ENABLE_NOVNC="${MAUMAU_BROWSER_ENABLE_NOVNC:-1}"
HEADLESS="${MAUMAU_BROWSER_HEADLESS:-0}"
ALLOW_NO_SANDBOX="${MAUMAU_BROWSER_NO_SANDBOX:-0}"
NOVNC_PASSWORD="${MAUMAU_BROWSER_NOVNC_PASSWORD:-}"
DISABLE_GRAPHICS_FLAGS="${MAUMAU_BROWSER_DISABLE_GRAPHICS_FLAGS:-1}"
DISABLE_EXTENSIONS="${MAUMAU_BROWSER_DISABLE_EXTENSIONS:-1}"
RENDERER_PROCESS_LIMIT="${MAUMAU_BROWSER_RENDERER_PROCESS_LIMIT:-2}"
