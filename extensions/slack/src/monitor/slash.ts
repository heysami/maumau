...
import { type ChatCommandDefinition, type CommandArgs } from "maumau/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "maumau/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "maumau_cmdarg";
