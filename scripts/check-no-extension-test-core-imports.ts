...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']maumau\/plugin-sdk["']/,
    hint: "Use maumau/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']maumau\/plugin-sdk\/test-utils["']/,
    hint: "Use maumau/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']maumau\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or maumau/plugin-sdk/testing for public surfaces.",
  },
  {
