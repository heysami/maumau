...
function resolveWatchPaths(workspaceDir: string, config?: MaumauConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: MaumauConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: MaumauConfig }) {
