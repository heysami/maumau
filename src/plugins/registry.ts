...
import type {
  ...
  MaumauPluginApi,
  MaumauPluginChannelRegistration,
  MaumauPluginCliRegistrar,
  MaumauPluginCommandDefinition,
  PluginConversationBindingResolvedEvent,
  MaumauPluginHttpRouteAuth,
  MaumauPluginHttpRouteMatch,
...
export type PluginToolRegistration = {
  pluginId: string;
  pluginName?: string;
  factory: MaumauPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
  rootDir?: string;
...
export type PluginCliRegistration = {
  pluginId: string;
  pluginName?: string;
  register: MaumauPluginCliRegistrar;
  commands: string[];
  source: string;
  rootDir?: string;
};
...
export type PluginCommandRegistration = {
  pluginId: string;
  pluginName?: string;
  command: MaumauPluginCommandDefinition;
  source: string;
  rootDir?: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: MaumauPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: MaumauPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: MaumauPluginHookOptions | undefined,
    config: MaumauPluginApi["config"],
  ) => {
  ...
  const registerHttpRoute = (record: PluginRecord, params: MaumauPluginHttpRouteParams) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: MaumauPluginChannelRegistration | ChannelPlugin,
    mode: PluginRegistrationMode = "full",
  ) => {
    const normalized =
      typeof (registration as MaumauPluginChannelRegistration).plugin === "object"
        ? (registration as MaumauPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: MaumauPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: MaumauPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: MaumauPluginCommandDefinition) => {
