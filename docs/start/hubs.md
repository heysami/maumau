---
summary: "Hubs that link to every Maumau doc"
read_when:
...
<Note>
If you are new to Maumau, start with [Getting Started](/start/getting-started).
</Note>
...
- [Weekly Reflection Reviewer](/automation/weekly-reflection-reviewer)
