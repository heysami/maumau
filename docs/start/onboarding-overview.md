---
summary: "Overview of Maumau onboarding options and flows"
read_when:
...
Maumau has two onboarding paths. Both configure auth, the Gateway, and
...
| **Command**    | `maumau onboard`                       | Launch the app            |
...
CLI command docs: [`maumau onboard`](/cli/onboard)

## macOS app onboarding

Open the Maumau app. The first-run wizard walks you through the same steps
