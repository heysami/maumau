...
export function applyAgentDefaultModelPrimary(cfg: MaumauConfig, primary: string): MaumauConfig {
...
export type ProviderOnboardPresetAppliers<TArgs extends unknown[]> = {
  applyProviderConfig: (cfg: MaumauConfig, ...args: TArgs) => MaumauConfig;
  applyConfig: (cfg: MaumauConfig, ...args: TArgs) => MaumauConfig;
};
...
>(params: {
  ...
  applyPreset: (cfg: MaumauConfig, preset: TParams) => MaumauConfig;
  primaryModelRef: string;
