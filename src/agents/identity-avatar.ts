...
function resolveAvatarSource(cfg: MaumauConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: MaumauConfig, agentId: string): AgentAvatarResolution {
