...
vi.mock("maumau/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("maumau/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("maumau/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("maumau/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("maumau/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("maumau/plugin-sdk/webhook-ingress");
  return {
    ...actual,
