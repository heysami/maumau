...
export function applyProviderDefaultModel(cfg: MaumauConfig, modelRef: string): MaumauConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: MaumauConfig; modelId: string; modelRef: string; profileId: string } {
