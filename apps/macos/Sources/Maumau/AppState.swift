...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = MaumauConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = MaumauConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: MaumauConfigFile.loadDict(),
        ...
        MaumauConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/maumau"
        state.remoteCliPath = ""
        return state
    }
}
