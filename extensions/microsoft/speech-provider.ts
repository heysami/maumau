...
import type { SpeechProviderPlugin } from "maumau/plugin-sdk/core";
import { resolvePreferredMaumauTmpDir } from "maumau/plugin-sdk/llm-task";
import { isVoiceCompatibleAudio } from "maumau/plugin-sdk/media-runtime";
import { edgeTTS, inferEdgeExtension, type SpeechVoiceOption } from "maumau/plugin-sdk/speech";
import {
...
export function buildMicrosoftSpeechProvider(): SpeechProviderPlugin {
  return {
    ...
    synthesize: async (req) => {
      const tempRoot = resolvePreferredMaumauTmpDir();
