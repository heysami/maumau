...
function resolveConfiguredDefaultNostrAccountId(cfg: MaumauConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: MaumauConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: MaumauConfig): string {
