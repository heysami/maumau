import { ensureAuthProfileStore, listProfilesForProvider } from "maumau/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "maumau/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "maumau/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "maumau/plugin-sdk/provider-auth-login";
