/**
 * Twitch channel plugin for Maumau.
 *
 ...
 * for Maumau. Supports message sending, receiving, access control, and
 * status monitoring.
 */
export const twitchPlugin: ChannelPlugin<ResolvedTwitchAccount> =
  createChatChannelPlugin<ResolvedTwitchAccount>({
    ...
    base: {
      ...
      config: {
        listAccountIds: (cfg: MaumauConfig): string[] => listAccountIds(cfg),
        resolveAccount: (cfg: MaumauConfig, accountId?: string | null): ResolvedTwitchAccount => {
        ...
        isConfigured: (_account: unknown, cfg: MaumauConfig): boolean =>
