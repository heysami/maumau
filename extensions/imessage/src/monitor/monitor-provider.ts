...
import { createChannelPairingChallengeIssuer } from "maumau/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "maumau/plugin-sdk/channel-reply-pipeline";
import { loadConfig } from "maumau/plugin-sdk/config-runtime";
import {
...
import { normalizeScpRemoteHost } from "maumau/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "maumau/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "maumau/plugin-sdk/media-runtime";
import { kindFromMime } from "maumau/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "maumau/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "maumau/plugin-sdk/reply-runtime";
...
import { danger, logVerbose, shouldLogVerbose, warn } from "maumau/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "maumau/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T maumau@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., maumau@192.168.64.3)
