...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "maumau/plugin-sdk/setup";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://maumau.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("maumau logs --follow")}\` (safest)`,
