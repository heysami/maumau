import { resolveAccountWithDefaultFallback } from "maumau/plugin-sdk/account-resolution";
import type { MaumauConfig } from "maumau/plugin-sdk/config-runtime";
import { coerceSecretRef } from "maumau/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "maumau/plugin-sdk/infra-runtime";
import { resolveDefaultSecretProviderAlias } from "maumau/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "maumau/plugin-sdk/routing";
import {
  hasConfiguredSecretInput,
  normalizeSecretInputString,
} from "maumau/plugin-sdk/secret-input";
...
function inspectTokenValue(params: { cfg: MaumauConfig; value: unknown }): {
  token: string;
