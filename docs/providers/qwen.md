---
summary: "Use Qwen OAuth (free tier) in Maumau"
read_when:
  - You want to use Qwen with Maumau
...
If you already logged in with the Qwen Code CLI, Maumau will sync credentials
