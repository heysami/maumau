...
function mergeZaloAccountConfig(cfg: MaumauConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: MaumauConfig): ResolvedZaloAccount[] {
