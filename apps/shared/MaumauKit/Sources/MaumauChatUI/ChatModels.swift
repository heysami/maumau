...
public typealias MaumauPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias MaumauPlatformImage = UIImage
#endif

public struct MaumauChatUsageCost: Codable, Hashable, Sendable {
...
public struct MaumauChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: MaumauChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(MaumauChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct MaumauChatMessageContent: Codable, Hashable, Sendable {
...
public struct MaumauChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [MaumauChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: MaumauChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [MaumauChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: MaumauChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(MaumauChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([MaumauChatMessageContent].self, forKey: .content) {
...
public struct MaumauChatHistoryPayload: Codable, Sendable {
...
public struct MaumauSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct MaumauSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [MaumauSessionPreviewItem]
}

public struct MaumauSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [MaumauSessionPreviewEntry]

    public init(ts: Int, previews: [MaumauSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct MaumauChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct MaumauChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct MaumauAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct MaumauChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct MaumauGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct MaumauPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: MaumauPlatformImage?
...
public struct MaumauChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
