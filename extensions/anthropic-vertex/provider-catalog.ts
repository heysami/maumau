import type { ModelDefinitionConfig, ModelProviderConfig } from "maumau/plugin-sdk/provider-models";
import { resolveAnthropicVertexRegion } from "maumau/plugin-sdk/provider-models";
