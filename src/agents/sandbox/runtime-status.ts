...
function resolveMainSessionKeyForSandbox(params: { cfg?: MaumauConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: MaumauConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(
    `- See: ${formatCliCommand(`maumau sandbox explain --session ${runtime.sessionKey}`)}`,
  );
