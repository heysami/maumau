...
let originalMaumauTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalMaumauTestConsole = process.env.MAUMAU_TEST_CONSOLE;
  process.env.MAUMAU_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalMaumauTestConsole === undefined) {
    delete process.env.MAUMAU_TEST_CONSOLE;
  } else {
    process.env.MAUMAU_TEST_CONSOLE = originalMaumauTestConsole;
  }
