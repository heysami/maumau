...
import { fetchGeminiUsage } from "maumau/plugin-sdk/provider-usage";
...
const ENV_VARS = [
  "MAUMAU_GEMINI_OAUTH_CLIENT_ID",
  "MAUMAU_GEMINI_OAUTH_CLIENT_SECRET",
...
export function registerGoogleGeminiCliProvider(api: MaumauPluginApi) {
