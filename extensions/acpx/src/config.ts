...
import type { MaumauPluginConfigSchema } from "../runtime-api.js";
...
function isAcpxPluginRoot(dir: string): boolean {
  return (
    fs.existsSync(path.join(dir, "maumau.plugin.json")) &&
...
export function createAcpxPluginConfigSchema(): MaumauPluginConfigSchema {
  return {
