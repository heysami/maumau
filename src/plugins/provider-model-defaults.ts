...
export function applyGoogleGeminiModelDefault(cfg: MaumauConfig): {
  next: MaumauConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: MaumauConfig): MaumauConfig {
...
export function applyOpenAIConfig(cfg: MaumauConfig): MaumauConfig {
...
export function applyOpencodeGoModelDefault(cfg: MaumauConfig): {
  next: MaumauConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: MaumauConfig): {
  next: MaumauConfig;
  changed: boolean;
} {
