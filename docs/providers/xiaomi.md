---
summary: "Use Xiaomi MiMo models with Maumau"
read_when:
  - You want Xiaomi MiMo models in Maumau
...
Xiaomi MiMo is the API platform for **MiMo** models. Maumau uses the Xiaomi
...
```bash
maumau onboard --auth-choice xiaomi-api-key
# or non-interactive
maumau onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
