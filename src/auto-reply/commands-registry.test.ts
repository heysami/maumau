...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@maumau", { botUsername: "maumau" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@maumau args", {
        botUsername: "maumau",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "maumau" })).toBe(
      "/help@otherbot",
    );
  });
