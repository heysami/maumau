...
import { PAIRING_APPROVED_MESSAGE, type ChannelPlugin, type MaumauConfig } from "./runtime-api.js";
import { normalizeSecretInputString } from "./secret-input.js";
import { sendMessageZalo } from "./send.js";

export async function notifyZaloPairingApproval(params: { cfg: MaumauConfig; id: string }) {
