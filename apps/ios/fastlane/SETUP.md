...
ASC_KEYCHAIN_SERVICE=maumau-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.maumau.client
# or
...
- The beta flow regenerates `apps/ios/Maumau.xcodeproj` from `apps/ios/project.yml` before archiving
