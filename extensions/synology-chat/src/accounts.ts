...
import { resolveDangerousNameMatchingEnabled } from "maumau/plugin-sdk/config-runtime";
import type {
...
/** Extract the channel config from the full Maumau config object. */
function getChannelConfig(cfg: MaumauConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: MaumauConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.MAUMAU_BOT_NAME ?? "Maumau";
