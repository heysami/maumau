...
summary: Machine-checked security models for Maumau’s highest-risk paths.
read_when:
...
This page tracks Maumau’s **formal security models** (TLA+/TLC today; more as needed).

> Note: some older links may refer to the previous project name.

**Goal (north star):** provide a machine-checked argument that Maumau enforces its
...
**What this is not (yet):** a proof that “Maumau is secure in all respects” or that the full TypeScript implementation is correct.

## Where the models live

Models are maintained in a separate repo: [vignesh07/maumau-formal-models](https://github.com/vignesh07/maumau-formal-models).
...
```bash
git clone https://github.com/vignesh07/maumau-formal-models
cd maumau-formal-models
