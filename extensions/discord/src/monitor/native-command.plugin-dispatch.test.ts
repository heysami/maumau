...
import type { MaumauConfig } from "../../../../src/config/config.js";
...
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("maumau/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
function createConfig(): MaumauConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: MaumauConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: MaumauConfig; name: string }) {
  return createDiscordNativeCommand({
    command: {
      name: params.name,
      description: "Pair",
...
async function createStatusCommand(cfg: MaumauConfig) {
...
describe("Discord native plugin command dispatch", () => {
  ...
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("maumau/plugin-sdk/plugin-runtime")
    >("maumau/plugin-sdk/plugin-runtime");
