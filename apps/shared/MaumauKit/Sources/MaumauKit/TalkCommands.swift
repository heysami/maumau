...
public enum MaumauTalkCommand: String, Codable, Sendable {
...
public struct MaumauTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct MaumauTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
