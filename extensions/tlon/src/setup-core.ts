...
export async function resolveTlonSetupConfigured(cfg: MaumauConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: MaumauConfig): Promise<string[]> {
