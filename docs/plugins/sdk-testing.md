...
summary: "Testing utilities and patterns for Maumau plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for Maumau
plugins.
...
**Import:** `maumau/plugin-sdk/testing`
...
} from "maumau/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "maumau/plugin-sdk/testing";
...
import type { PluginRuntime } from "maumau/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `maumau/plugin-sdk` root barrel is rejected
...
Maumau uses Vitest with V8 coverage thresholds. For plugin tests:
