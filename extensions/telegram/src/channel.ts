...
} from "maumau/plugin-sdk/allowlist-config-edit";
import { createPairingPrefixStripper } from "maumau/plugin-sdk/channel-pairing";
import { createAllowlistProviderRouteAllowlistWarningCollector } from "maumau/plugin-sdk/channel-policy";
import { attachChannelToResult } from "maumau/plugin-sdk/channel-send-result";
import { createChatChannelPlugin } from "maumau/plugin-sdk/core";
import { createChannelDirectoryAdapter } from "maumau/plugin-sdk/directory-runtime";
import { resolveExecApprovalCommandDisplay } from "maumau/plugin-sdk/infra-runtime";
import { buildExecApprovalPendingReplyPayload } from "maumau/plugin-sdk/infra-runtime";
import { resolveOutboundSendDep, type OutboundSendDeps } from "maumau/plugin-sdk/outbound-runtime";
import {
...
function hasTelegramExecApprovalDmRoute(cfg: MaumauConfig): boolean {
  ...
  base: {
    ...
    gateway: {
      ...
      logoutAccount: async ({ accountId, cfg }) => {
        ...
        const nextCfg = { ...cfg } as MaumauConfig;
