...
export type DiscordConfig = NonNullable<MaumauConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("maumau/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "maumau-bot",
