...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): MaumauConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: MaumauConfig, env: NodeJS.ProcessEnv) =>
