...
import type { MaumauConfig, ReplyToMode } from "maumau/plugin-sdk/config-runtime";
...
import { getPluginCommandSpecs } from "maumau/plugin-sdk/plugin-runtime";
...
import {
  ...
  shouldLogVerbose,
  warn,
} from "maumau/plugin-sdk/runtime-env";
...
import { summarizeStringEntries } from "maumau/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("maumau/plugin-sdk/reply-history").HistoryEntry[]
    >();
