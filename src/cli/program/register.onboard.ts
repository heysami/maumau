...
export function registerOnboardCommand(program: Command) {
  const command = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/onboard", "docs.maumau.ai/cli/onboard")}\n`,
    )
    ...
    .option("--preset <id>", "Setup preset: conversation-automation")
  ...
  command
    ...
    .option(
      ...
      "Gateway token SecretRef env var name (token auth; e.g. MAUMAU_GATEWAY_TOKEN)",
    )
      ...
      await setupWizardCommand(
        {
          ...
          preset: opts.preset as "conversation-automation" | undefined,
