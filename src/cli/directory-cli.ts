    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["maumau directory self --channel slack", "Show the connected account identity."],
          [
            'maumau directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["maumau directory groups list --channel discord", "List available groups/channels."],
          [
            "maumau directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.maumau.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
