...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.MAUMAU_SERVICE_MARKER;
  ...
  beforeEach(async () => {
    ...
    delete process.env.MAUMAU_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.MAUMAU_SERVICE_MARKER = originalServiceMarker;
    }
  });
