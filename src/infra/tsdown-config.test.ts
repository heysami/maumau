  ...
  it("keeps core, plugin runtime, plugin-sdk, bundled plugins, and bundled hooks in one dist graph", () => {
    ...
    expect(entryKeys(distGraphs[0])).toEqual(
      expect.arrayContaining([
        ...
        "agents/model-suppression.runtime",
        "agents/pi-embedded.runtime",
        "agents/pi-model-discovery-runtime",
        "auto-reply/reply/session-updates.runtime",
        "index",
        "cli/memory-cli",
        "wizard/model-auth",
        "commands/auth-choice",
        "commands/auth-choice-options",
        "commands/auth-choice-prompt",
        "commands/model-picker",
        "commands/onboard-custom",
        "commands/status.summary.runtime",
        "plugins/provider-runtime.runtime",
        "wizard/setup.runtime",
