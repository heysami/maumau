...
export function mergeSlackAccountConfig(cfg: MaumauConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: MaumauConfig): ResolvedSlackAccount[] {
