...
export function resolveTavilySearchConfig(cfg?: MaumauConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: MaumauConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: MaumauConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
