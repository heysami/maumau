...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "maumau/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("maumau.discordThreadBindingsState");
