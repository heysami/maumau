...
type ResolveConfiguredBindingRouteFn =
  typeof import("maumau/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
...
vi.mock("maumau/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  ...
  beforeEach(() => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/maumau-sessions.json");
