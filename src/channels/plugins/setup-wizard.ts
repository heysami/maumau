...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: MaumauConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: MaumauConfig; accountId: string }) => boolean;
  apply: (params: { cfg: MaumauConfig; accountId: string }) => MaumauConfig | Promise<MaumauConfig>;
};
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: MaumauConfig; accountId: string }) => boolean;
  inspect: (params: { cfg: MaumauConfig; accountId: string }) => ChannelSetupWizardCredentialState;
  shouldPrompt?: (params: {
    cfg: MaumauConfig;
    accountId: string;
    credentialValues: ChannelSetupWizardCredentialValues;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: MaumauConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: MaumauConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: MaumauConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: MaumauConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: MaumauConfig) => MaumauConfig;
