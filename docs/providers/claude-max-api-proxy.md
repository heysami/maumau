...
You can point Maumau at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Maumau
...
- [Anthropic provider](/providers/anthropic) - Native Maumau integration with Claude setup-token or API keys
