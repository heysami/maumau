...
import type { MaumauConfig, PluginRuntime, ResolvedLineAccount } from "../api.js";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: MaumauConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: MaumauConfig; accountId: string }): Promise<{
