...
const compiledRegistryCache = new WeakMap<MaumauConfig, CachedCompiledConfiguredBindingRegistry>();
...
export function primeCompiledBindingRegistry(cfg: MaumauConfig): CompiledConfiguredBindingRegistry {
