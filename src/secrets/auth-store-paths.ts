...
export function listAuthProfileStorePaths(config: MaumauConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: MaumauConfig, stateDir: string): string[] {
