...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: MaumauConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: MaumauConfig): AcpManagerObservabilitySnapshot {
  ...
  private resolveTurnTimeoutMs(params: { cfg: MaumauConfig; meta: SessionAcpMeta }): number {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: MaumauConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(params: { cfg: MaumauConfig }): Promise<void> {
