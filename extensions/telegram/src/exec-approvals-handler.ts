...
import { GatewayClient } from "maumau/plugin-sdk/gateway-runtime";
import { createOperatorApprovalsGatewayClient } from "maumau/plugin-sdk/gateway-runtime";
import type { EventFrame } from "maumau/plugin-sdk/gateway-runtime";
import { resolveExecApprovalCommandDisplay } from "maumau/plugin-sdk/infra-runtime";
import {
  buildExecApprovalPendingReplyPayload,
  type ExecApprovalPendingReplyParams,
} from "maumau/plugin-sdk/infra-runtime";
import { resolveExecApprovalSessionTarget } from "maumau/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "maumau/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "maumau/plugin-sdk/routing";
import { createSubsystemLogger } from "maumau/plugin-sdk/runtime-env";
import type { RuntimeEnv } from "maumau/plugin-sdk/runtime-env";
import { compileSafeRegex, testRegexWithBoundedInput } from "maumau/plugin-sdk/security-runtime";
...
function isHandlerConfigured(params: { cfg: MaumauConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
