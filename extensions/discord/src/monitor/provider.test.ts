...
function createConfigWithDiscordAccount(overrides: Record<string, unknown> = {}): MaumauConfig {
  return {
    channels: {
      discord: {
        accounts: {
...
vi.mock("maumau/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("maumau/plugin-sdk/plugin-runtime")>(
