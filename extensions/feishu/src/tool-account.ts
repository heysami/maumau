...
import type { MaumauPluginApi } from "../runtime-api.js";
...
function readConfiguredDefaultAccountId(config: MaumauPluginApi["config"]): string | undefined {
...
export function resolveFeishuToolAccount(params: {
  api: Pick<MaumauPluginApi, "config">;
