...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: MaumauPhotosLatestParams) async throws -> MaumauPhotosLatestPayload {
        ...
        var results: [MaumauPhotoPayload] = []
        ...
        return MaumauPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> MaumauPhotoPayload
    {
