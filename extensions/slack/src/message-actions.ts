import { createActionGate } from "maumau/plugin-sdk/agent-runtime";
import type { ChannelMessageActionName } from "maumau/plugin-sdk/channel-contract";
import type { MaumauConfig } from "maumau/plugin-sdk/config-runtime";
import type { ChannelToolSend } from "maumau/plugin-sdk/tool-send";
import { listEnabledSlackAccounts } from "./accounts.js";

export function listSlackMessageActions(cfg: MaumauConfig): ChannelMessageActionName[] {
