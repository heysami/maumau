...
export function isCliProvider(provider: string, cfg?: MaumauConfig): boolean {
...
function resolveAllowedFallbacks(params: { cfg: MaumauConfig; agentId?: string }): string[] {
  if (params.agentId) {
...
export function buildConfiguredModelCatalog(params: { cfg: MaumauConfig }): ModelCatalogEntry[] {
