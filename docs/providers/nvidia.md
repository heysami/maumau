---
summary: "Use NVIDIA's OpenAI-compatible API in Maumau"
read_when:
  - You want to use NVIDIA models in Maumau
...
maumau onboard --auth-choice skip
maumau models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
