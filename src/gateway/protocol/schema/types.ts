...
export type TeamPromptEditParams = SchemaType<"TeamPromptEditParams">;
export type TeamPromptEditResult = SchemaType<"TeamPromptEditResult">;
export type TeamPromptEditTeamPatch = SchemaType<"TeamPromptEditTeamPatch">;
export type TeamPromptEditMember = SchemaType<"TeamPromptEditMember">;
export type TeamPromptEditCrossTeamLink = SchemaType<"TeamPromptEditCrossTeamLink">;
export type TeamPromptEditWorkflowPatch = SchemaType<"TeamPromptEditWorkflowPatch">;
export type TeamPromptEditWorkflowContract = SchemaType<"TeamPromptEditWorkflowContract">;
export type TeamPromptEditLifecycleStage = SchemaType<"TeamPromptEditLifecycleStage">;
export type TeamPromptEditAgentPatch = SchemaType<"TeamPromptEditAgentPatch">;
export type TeamPromptEditAgentIdentityPatch = SchemaType<"TeamPromptEditAgentIdentityPatch">;
