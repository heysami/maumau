...
export const DEFAULT_SANDBOX_IMAGE = "maumau-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "maumau-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "maumau-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "maumau-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "maumau-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "maumau-sandbox-browser";
