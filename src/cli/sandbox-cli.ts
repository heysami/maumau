...
const SANDBOX_EXAMPLES = {
  main: [
    ["maumau sandbox list", "List all sandbox containers."],
    ["maumau sandbox list --browser", "List only browser containers."],
    ["maumau sandbox recreate --all", "Recreate all containers."],
    ["maumau sandbox recreate --session main", "Recreate a specific session."],
    ["maumau sandbox recreate --agent mybot", "Recreate agent containers."],
    ["maumau sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["maumau sandbox list", "List all sandbox containers."],
    ["maumau sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["maumau sandbox recreate --all", "Recreate all containers."],
    ["maumau sandbox recreate --session main", "Recreate a specific session."],
    ["maumau sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["maumau sandbox recreate --browser --all", "Recreate only browser containers."],
    ["maumau sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["maumau sandbox explain", "Show effective sandbox config."],
    ["maumau sandbox explain --session agent:main:main", "Explain a specific session."],
    ["maumau sandbox explain --agent work", "Explain an agent sandbox."],
    ["maumau sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.maumau.ai/cli/sandbox")}\n`,
    )
    .action(() => {
