...
function collectExecSafeBinScopes(cfg: MaumauConfig): ExecSafeBinScopeRef[] {
...
export function scanExecSafeBinCoverage(cfg: MaumauConfig): ExecSafeBinCoverageHit[] {
...
export function scanExecSafeBinTrustedDirHints(cfg: MaumauConfig): ExecSafeBinTrustedDirHintHit[] {
...
export function maybeRepairExecSafeBinProfiles(cfg: MaumauConfig): {
  config: MaumauConfig;
  changes: string[];
  warnings: string[];
} {
