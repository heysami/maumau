...
import { loadConfig, writeConfigFile, type MaumauConfig } from "../config/config.js";
...
function isConfiguredAuthPlugin(plugin: ChannelPlugin, cfg: MaumauConfig): boolean {
...
function resolveConfiguredAuthChannelInput(cfg: MaumauConfig, mode: ChannelAuthMode): string {
...
function resolveAccountContext(plugin: ChannelPlugin, opts: ChannelAuthOptions, cfg: MaumauConfig) {
