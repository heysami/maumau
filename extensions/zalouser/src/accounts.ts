...
function mergeZalouserAccountConfig(cfg: MaumauConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: MaumauConfig; accountId?: string | null }) {
