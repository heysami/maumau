...
const execHostEnforced = process.env.MAUMAU_NODE_EXEC_HOST?.trim().toLowerCase() === "app";
const execHostFallbackAllowed = process.env.MAUMAU_NODE_EXEC_FALLBACK?.trim().toLowerCase() !== "0";
