...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = MaumauLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.maumau.ios", category: "GatewaySettings")
                ...
                Section {
                    DisclosureGroup(isExpanded: self.$gatewayExpanded) {
                        if !self.isGatewayConnected {
                            Text(
                                "1. Open a chat with your Maumau agent and send /pair\n"
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected Maumau agent.") { newValue in
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for Maumau. "
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while Maumau is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("Maumau", value: DeviceInfoHelper.maumauVersionString())
                    }
                }
            }
    ...
    private func friendlyGatewayMessage(from raw: String) -> String? {
        ...
        if lower.contains("pairing required") {
            return "Pairing required. Go back to your Maumau chat and run /pair approve, then tap Connect again."
        }
