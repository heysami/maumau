import { createScopedExpiringIdCache, resolveGlobalMap } from "maumau/plugin-sdk/text-runtime";
 ...
 */
const TELEGRAM_SENT_MESSAGES_KEY = Symbol.for("maumau.telegramSentMessages");
