...
function resolveResolutionLimits(config: MaumauConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: MaumauConfig): SecretProviderConfig {
