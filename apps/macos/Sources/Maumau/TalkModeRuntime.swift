...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.maumau", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.maumau", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [MaumauChatMessage] = messages.compactMap { item in
