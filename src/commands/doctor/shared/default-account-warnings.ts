...
export function collectMissingDefaultAccountBindingWarnings(cfg: MaumauConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: MaumauConfig): string[] {
  const warnings: string[] = [];
