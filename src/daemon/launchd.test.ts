...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.maumau.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", MAUMAU_PROFILE: "default" },
    });
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.maumau.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when MAUMAU_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.maumau.gateway.plist",
    },
    {
      name: "uses profile-specific label when MAUMAU_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", MAUMAU_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.maumau.jbphoenix.plist",
    },
    {
      name: "prefers MAUMAU_LAUNCHD_LABEL over MAUMAU_PROFILE",
      env: {
        HOME: "/Users/test",
        MAUMAU_PROFILE: "jbphoenix",
        MAUMAU_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from MAUMAU_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        MAUMAU_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty MAUMAU_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        MAUMAU_PROFILE: "myprofile",
        MAUMAU_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.maumau.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
