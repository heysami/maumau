...
import { createArmableStallWatchdog } from "maumau/plugin-sdk/channel-lifecycle";
import { createConnectedChannelStatusPatch } from "maumau/plugin-sdk/gateway-runtime";
import { danger } from "maumau/plugin-sdk/runtime-env";
...
export async function runDiscordGatewayLifecycle(params: {
  ...
  try {
    ...
    // Carbon starts the gateway during client construction, before Maumau can
