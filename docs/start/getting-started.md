---
summary: "Get Maumau installed and run your first chat in minutes."
read_when:
...
Install Maumau, run onboarding, and chat with your AI assistant — all in
...
<Accordion title="Advanced: environment variables">
  If you run Maumau as a service account or want custom paths:

- `MAUMAU_HOME` — home directory for internal path resolution
- `MAUMAU_STATE_DIR` — override the state directory
- `MAUMAU_CONFIG_PATH` — override the config file path
