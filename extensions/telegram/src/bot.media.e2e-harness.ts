...
import type { GetReplyOptions, MsgContext } from "maumau/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("maumau/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as MaumauConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("maumau/plugin-sdk/media-runtime")>,
) {
...
vi.mock("maumau/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("maumau/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("maumau/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
