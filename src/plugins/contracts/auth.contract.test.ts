...
type LoginOpenAICodexOAuth =
  (typeof import("maumau/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("maumau/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("maumau/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("maumau/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("maumau/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("maumau/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("maumau/plugin-sdk/agent-runtime", async (importOriginal) => {
