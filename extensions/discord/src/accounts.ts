...
import { normalizeAccountId } from "maumau/plugin-sdk/account-id";
import { resolveAccountEntry } from "maumau/plugin-sdk/routing";
import type { DiscordAccountConfig, DiscordActionConfig, MaumauConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: MaumauConfig): ResolvedDiscordAccount[] {
