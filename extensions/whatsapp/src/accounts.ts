...
export function listWhatsAppAuthDirs(cfg: MaumauConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: MaumauConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: MaumauConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: MaumauConfig): ResolvedWhatsAppAccount[] {
