...
import { formatDurationSeconds } from "maumau/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("maumau/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("maumau/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("maumau/plugin-sdk/runtime-env").createSubsystemLogger>;
