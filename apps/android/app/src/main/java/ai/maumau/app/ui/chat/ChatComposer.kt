...
import ai.maumau.app.ui.mobileAccentBorderStrong
...
import ai.maumau.app.ui.mobileSurface
import ai.maumau.app.ui.mobileText
import ai.maumau.app.ui.mobileTextSecondary
import ai.maumau.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.maumau.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.maumau.app.ui.mobileFontFamily,
