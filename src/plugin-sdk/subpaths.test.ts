...
import type {
  ...
  MaumauPluginApi as CoreMaumauPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "maumau/plugin-sdk/core";
import * as providerEntrySdk from "maumau/plugin-sdk/provider-entry";
...
import type { MaumauPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  MaumauPluginApi as SharedMaumauPluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreMaumauPluginApi>().toMatchTypeOf<MaumauPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreMaumauPluginApi>().toMatchTypeOf<SharedMaumauPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("maumau/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("maumau/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("maumau/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("maumau/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("maumau/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("maumau/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`maumau/plugin-sdk/${id}`),
      ),
    ]);
