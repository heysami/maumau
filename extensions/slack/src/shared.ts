...
import { createChannelPluginBase } from "maumau/plugin-sdk/core";
import {
  formatDocsLink,
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Maumau";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Maumau`,
    },
    features: {
      bot_user: {
...
export function buildSlackSetupLines(botName = "Maumau"): string[] {
  return [
