...
show_usage() {
    cat << EOF
clawlog - Maumau Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Maumau logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Maumau logs flow through the macOS unified log (subsystem: ai.maumau).
