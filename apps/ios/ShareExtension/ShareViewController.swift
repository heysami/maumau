...
final class ShareViewController: UIViewController {
    ...
    private let logger = Logger(subsystem: "ai.maumau.ios", category: "ShareExtension")
    ...
    private func setupUI() {
        ...
        self.sendButton.setTitle("Send to Maumau", for: .normal)
    ...
    private func sendCurrentDraft() async {
        ...
        self.showStatus("Sending to Maumau gateway…")
        ...
        do {
            ...
            self.showStatus("Sent to Maumau.")
    ...
    private func sendMessageToGateway(_ message: String, attachments: [ShareAttachment]) async throws {
        guard let config = ShareGatewayRelaySettings.loadConfig() else {
            throw NSError(
                domain: "MaumauShare",
                code: 10,
                userInfo: [NSLocalizedDescriptionKey: "Maumau is not connected to a gateway yet."])
        }
        ...
        let makeOptions: (String) -> GatewayConnectOptions = { clientId in
            GatewayConnectOptions(
                ...
                clientId: clientId,
                clientMode: "node",
                clientDisplayName: "Maumau Share",
        ...
        do {
            try await gateway.connect(
                ...
                connectOptions: makeOptions("maumau-ios"),
                sessionBox: nil,
                onConnected: {},
                onDisconnected: { _ in },
                onInvoke: { req in
