...
import { parseDurationMs } from "maumau/plugin-sdk/cli-runtime";
import {
  definePluginEntry,
...
import { normalizeModelCompat } from "maumau/plugin-sdk/provider-models";
import { fetchClaudeUsage } from "maumau/plugin-sdk/provider-usage";
...
function buildAnthropicAuthDoctorHint(params: {
  ...
  return [
    ...
    `Fix: run "${formatCliCommand("maumau doctor --yes")}"`,
  ].join("\n");
}
