import { describeAccountSnapshot } from "maumau/plugin-sdk/account-helpers";
import { formatAllowFromLowercase } from "maumau/plugin-sdk/allow-from";
import { createMessageToolCardSchema } from "maumau/plugin-sdk/channel-actions";
import { createTopLevelChannelConfigAdapter } from "maumau/plugin-sdk/channel-config-helpers";
import type {
  ChannelMessageActionAdapter,
  ChannelMessageToolDiscovery,
} from "maumau/plugin-sdk/channel-contract";
import { createPairingPrefixStripper } from "maumau/plugin-sdk/channel-pairing";
import {
  createAllowlistProviderGroupPolicyWarningCollector,
  projectConfigWarningCollector,
} from "maumau/plugin-sdk/channel-policy";
import { createChatChannelPlugin } from "maumau/plugin-sdk/core";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
  listDirectoryEntriesFromSources,
} from "maumau/plugin-sdk/directory-runtime";
import { createLazyRuntimeNamedExport } from "maumau/plugin-sdk/lazy-runtime";
import { createRuntimeOutboundDelegates } from "maumau/plugin-sdk/outbound-runtime";
import { createComputedAccountStatusAdapter } from "maumau/plugin-sdk/status-helpers";
import type { ChannelMessageActionName, ChannelPlugin, MaumauConfig } from "../runtime-api.js";
import {
...
const resolveMSTeamsChannelConfig = (cfg: MaumauConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: MaumauConfig }>(
