...
import { buildPluginBindingApprovalCustomId } from "maumau/plugin-sdk/conversation-runtime";
...
async function createInfraRuntimeMock(
  importOriginal: () => Promise<typeof import("maumau/plugin-sdk/infra-runtime")>,
) {
...
vi.mock("maumau/plugin-sdk/infra-runtime", createInfraRuntimeMock);
vi.mock("maumau/plugin-sdk/infra-runtime.js", createInfraRuntimeMock);
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/maumau-sessions-test.json");
