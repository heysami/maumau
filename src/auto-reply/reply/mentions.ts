...
function resolveMentionPatterns(cfg: MaumauConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: MaumauConfig | undefined, agentId?: string): RegExp[] {
