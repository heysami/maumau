...
- Install via CLI: `maumau plugins install @maumau/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `maumau plugins install ./extensions/zalo`
   - From npm (if published): `maumau plugins install @maumau/zalo`
...
This page reflects current Maumau behavior for **Zalo Bot Creator / Marketplace bots**.
...
- Approve via:
  - `maumau pairing list zalo`
  - `maumau pairing approve zalo <CODE>`
...
This table summarizes current **Zalo Bot Creator / Marketplace bot** behavior in Maumau.
...
- Example: `maumau message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `maumau channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `maumau logs --follow`
