...
function resolveAnthropicDefaultAuthMode(cfg: MaumauConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: MaumauConfig): MaumauConfig {
...
export function applyTalkApiKey(config: MaumauConfig): MaumauConfig {
...
export function applyTalkConfigNormalization(config: MaumauConfig): MaumauConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: MaumauConfig): MaumauConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: MaumauConfig): MaumauConfig {
...
export function applyLoggingDefaults(cfg: MaumauConfig): MaumauConfig {
...
export function applyContextPruningDefaults(cfg: MaumauConfig): MaumauConfig {
...
export function applyCompactionDefaults(cfg: MaumauConfig): MaumauConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
