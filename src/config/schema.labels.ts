...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "teams.list[].members[].description": "Specialist Guidance",
  "teams.list[].crossTeamLinks": "Cross-Team Links",
  "teams.list[].crossTeamLinks[].type": "Cross-Team Link Type",
  "teams.list[].crossTeamLinks[].targetId": "Cross-Team Link Target",
  "teams.list[].crossTeamLinks[].description": "Cross-Team Link Description",
  "teams.list[].workflows": "Team Workflows",
  "teams.list[].workflows[].id": "Workflow ID",
  "teams.list[].workflows[].name": "Workflow Name",
  "teams.list[].workflows[].description": "Workflow Description",
  "teams.list[].workflows[].default": "Default Workflow",
  "teams.list[].workflows[].managerPrompt": "Manager Workflow Prompt",
  "teams.list[].workflows[].synthesisPrompt": "Synthesis Workflow Prompt",
  "teams.list[].workflows[].lifecycle": "Workflow Lifecycle",
  "teams.list[].workflows[].lifecycle.stages": "Workflow Lifecycle Stages",
  "teams.list[].workflows[].lifecycle.stages[].id": "Lifecycle Stage ID",
  "teams.list[].workflows[].lifecycle.stages[].name": "Lifecycle Stage Name",
  "teams.list[].workflows[].lifecycle.stages[].status": "Lifecycle Stage Status",
  "teams.list[].workflows[].lifecycle.stages[].roles": "Lifecycle Stage Roles",
  "teams.list[].workflow": "Legacy Team Workflow",
  "teams.list[].workflow.managerPrompt": "Legacy Manager Workflow Prompt",
  "teams.list[].workflow.synthesisPrompt": "Legacy Synthesis Workflow Prompt",
  "teams.list[].preset": "Team Preset Metadata",
  "teams.list[].preset.id": "Preset ID",
  "teams.list[].preset.source": "Preset Source",
  "teams.list[].preset.version": "Preset Version",
  ...
  "agents.defaults.background": "Background Automation",
  "agents.defaults.background.model": "Background Model Override",
  "agents.defaults.background.thinking": "Background Thinking Default",
  "agents.defaults.heartbeat.directPolicy": "Heartbeat Direct Policy",
  "agents.defaults.heartbeat.thinking": "Heartbeat Thinking Default",
  ...
  "agents.list[].background": "Background Automation",
  "agents.list[].background.model": "Background Model Override",
  "agents.list[].background.thinking": "Background Thinking Default",
  "agents.list[].heartbeat.thinking": "Heartbeat Thinking Default",
  ...
  "ui.mauOffice": "MauOffice",
  "ui.mauOffice.enabled": "MauOffice Enabled",
  "ui.mauOffice.maxVisibleWorkers": "MauOffice Max Visible Workers",
  "ui.mauOffice.idlePackages": "MauOffice Idle Packages",
  "ui.mauOffice.idlePackages.enabled": "MauOffice Enabled Idle Packages",
  "ui.mauOffice.scene": "MauOffice Scene",
  "ui.mauOffice.scene.version": "MauOffice Scene Version",
  "ui.mauOffice.scene.zoneRows": "MauOffice Scene Zone Rows",
  "ui.mauOffice.scene.wallRows": "MauOffice Scene Wall Rows",
  "ui.mauOffice.scene.props": "MauOffice Scene Props",
  "ui.mauOffice.scene.autotiles": "MauOffice Scene Autotiles",
  "ui.mauOffice.scene.markers": "MauOffice Scene Markers",
  ...
  "channels.telegram.dmPolicy": "Who Can Start a Direct Chat",
  ...
  "channels.whatsapp.dmPolicy": "Who Can Start a Direct Chat",
  "channels.whatsapp.selfChatMode": "Use the Same WhatsApp Account (Legacy)",
  "channels.whatsapp.debounceMs": "WhatsApp Message Debounce (ms)",
  "channels.whatsapp.configWrites": "WhatsApp Config Writes",
  "channels.signal.dmPolicy": "Who Can Start a Direct Chat",
  "channels.signal.configWrites": "Signal Config Writes",
  "channels.imessage.dmPolicy": "Who Can Start a Direct Chat",
  "channels.imessage.configWrites": "iMessage Config Writes",
  "channels.bluebubbles.dmPolicy": "Who Can Start a Direct Chat",
  "channels.msteams.configWrites": "MS Teams Config Writes",
  "channels.irc.configWrites": "IRC Config Writes",
  "channels.discord.dmPolicy": "Who Can Start a Direct Chat",
  "channels.discord.dm.policy": "Who Can Start a Direct Chat",
  ...
  "channels.slack.dm.policy": "Who Can Start a Direct Chat",
  "channels.slack.dmPolicy": "Who Can Start a Direct Chat",
