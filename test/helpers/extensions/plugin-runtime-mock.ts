import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "maumau/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "maumau/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "maumau/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/maumau"),
    },
    modelAuth: {
