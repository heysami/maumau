...
function enableSlackAccount(cfg: MaumauConfig, accountId: string): MaumauConfig {
...
function hasSlackInteractiveRepliesConfig(cfg: MaumauConfig, accountId: string): boolean {
...
function createSlackTokenCredential(params: {
  ...
  return {
    ...
    applyUseEnv: ({ cfg, accountId }: { cfg: MaumauConfig; accountId: string }) =>
