...
import { danger, logVerbose } from "maumau/plugin-sdk/runtime-env";
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): MaumauConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: MaumauConfig): TelegramAccountConfig => {
    try {
