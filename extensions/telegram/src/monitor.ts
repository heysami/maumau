...
import { resolveAgentMaxConcurrent } from "maumau/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "maumau/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: MaumauConfig): RunOptions<unknown> {
  return {
    sink: {
