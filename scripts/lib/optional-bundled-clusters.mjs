...
export const OPTIONAL_BUNDLED_BUILD_ENV = "MAUMAU_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.maumau?.install?.npmSpec === "string" &&
    packageJson.maumau.install.npmSpec.trim().length > 0
  );
}
