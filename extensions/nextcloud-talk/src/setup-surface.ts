import type { ChannelSetupInput } from "maumau/plugin-sdk/channel-setup";
import type { MaumauConfig } from "maumau/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "maumau/plugin-sdk/routing";
import { hasConfiguredSecretInput } from "maumau/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "Maumau" "<shared-secret>" "<webhook-url>" --feature reaction',
