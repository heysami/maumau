...
export async function dashboardCommand(
  ...
  if (resolvedToken.unresolvedRefReason) {
    ...
    runtime.log(
      "Set MAUMAU_GATEWAY_TOKEN in this shell or resolve your secret provider, then rerun `maumau dashboard`.",
    );
  }
  ...
  if (opened) {
    runtime.log("Opened in your browser. Keep that tab to control Maumau.");
  } else if (hint) {
    runtime.log(hint);
  }
}
