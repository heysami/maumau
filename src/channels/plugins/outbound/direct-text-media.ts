...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: MaumauConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: MaumauConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: "imessage" | "signal") {
  return (params: { cfg: MaumauConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: MaumauConfig; accountId?: string | null }) => number | undefined;
