...
import { resolveLineAccount, type MaumauConfig, type ResolvedLineAccount } from "../runtime-api.js";
...
export function isLineConfigured(cfg: MaumauConfig, accountId: string): boolean {
