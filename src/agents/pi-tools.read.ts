...
function resolveAdaptiveReadMaxBytes(options?: MaumauReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createMaumauReadTool(base, {
...
export function createMaumauReadTool(
  base: AnyAgentTool,
  options?: MaumauReadToolOptions,
): AnyAgentTool {
