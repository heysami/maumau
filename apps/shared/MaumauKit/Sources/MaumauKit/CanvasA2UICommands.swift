...
public enum MaumauCanvasA2UICommand: String, Codable, Sendable {
...
public struct MaumauCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct MaumauCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
