...
// Prefix for Maumau-generated action IDs to scope our handler
const MAUMAU_ACTION_PREFIX = "maumau:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${MAUMAU_ACTION_PREFIX}`);

  // Handle Maumau modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
