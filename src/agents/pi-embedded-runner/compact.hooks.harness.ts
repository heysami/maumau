...
export const createMaumauCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createMaumauCodingToolsMock.mockReset();
  createMaumauCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureMaumauModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveMaumauDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createMaumauCodingTools: createMaumauCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveMaumauAgentDir: vi.fn(() => "/tmp"),
  }));
