import { buildMentionRegexes, normalizeMentionText } from "maumau/plugin-sdk/channel-inbound";
import type { loadConfig } from "maumau/plugin-sdk/config-runtime";
import { isSelfChatMode, jidToE164, normalizeE164 } from "maumau/plugin-sdk/text-runtime";
