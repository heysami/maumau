...
import { resolveAgentDir } from "maumau/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "maumau/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "maumau/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "maumau/plugin-sdk/config-runtime";
import { formatErrorMessage } from "maumau/plugin-sdk/infra-runtime";
import { resolvePreferredMaumauTmpDir } from "maumau/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "maumau/plugin-sdk/media-understanding-runtime";
...
import { createSubsystemLogger } from "maumau/plugin-sdk/runtime-env";
import type { RuntimeEnv } from "maumau/plugin-sdk/runtime-env";
import { parseTtsDirectives } from "maumau/plugin-sdk/speech";
import { textToSpeech } from "maumau/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: MaumauConfig; override?: TtsConfig }): {
  cfg: MaumauConfig;
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredMaumauTmpDir(), "discord-voice-"));
