...
export type SearchConfigRecord = (NonNullable<MaumauConfig["tools"]>["web"] extends infer Web
...
const SEARCH_CACHE_KEY = Symbol.for("maumau.web-search.cache");
...
export function parseIsoDateRange(params: {
  ...
  const docs = params.docs ?? "https://docs.maumau.ai/tools/web";
