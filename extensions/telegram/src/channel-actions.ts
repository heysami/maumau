...
} from "maumau/plugin-sdk/channel-actions";
...
import type { TelegramActionConfig } from "maumau/plugin-sdk/config-runtime";
import { extractToolSend } from "maumau/plugin-sdk/tool-send";
import {
