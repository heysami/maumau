import { DEFAULT_ACCOUNT_ID, type MaumauConfig } from "maumau/plugin-sdk/account-resolution";
import { waitUntilAbort } from "maumau/plugin-sdk/channel-lifecycle";
import { registerPluginHttpRoute } from "maumau/plugin-sdk/webhook-ingress";
