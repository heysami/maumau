...
import { isSecretRef, type MaumauConfig } from "maumau/plugin-sdk/core";
...
export function listEnabledGoogleChatAccounts(cfg: MaumauConfig): ResolvedGoogleChatAccount[] {
