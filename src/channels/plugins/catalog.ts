...
import { discoverMaumauPlugins } from "../../plugins/discovery.js";
import { getPackageManifestMetadata } from "../../plugins/manifest.js";
import { loadPluginManifest } from "../../plugins/manifest.js";
import type { MaumauPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, MaumauPackageManifest>>;
...
function resolveOfficialCatalogPaths(options: CatalogOptions): string[] {
  ...
  const packageRoots = [
    resolveMaumauPackageRootSync({ cwd: process.cwd() }),
    resolveMaumauPackageRootSync({ moduleUrl: import.meta.url }),
...
function toChannelMeta(params: {
  channel: NonNullable<MaumauPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: MaumauPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
