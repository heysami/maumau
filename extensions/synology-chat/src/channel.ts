/**
 * Synology Chat Channel Plugin for Maumau.
 *
 * Implements the ChannelPlugin interface following the LINE pattern.
 */

import type { MaumauConfig } from "maumau/plugin-sdk/account-resolution";
import {
  createHybridChannelConfigAdapter,
  createScopedDmSecurityResolver,
} from "maumau/plugin-sdk/channel-config-helpers";
import { waitUntilAbort } from "maumau/plugin-sdk/channel-lifecycle";
import {
...
import { createChatChannelPlugin, type ChannelPlugin } from "maumau/plugin-sdk/core";
import { createEmptyChannelDirectoryAdapter } from "maumau/plugin-sdk/directory-runtime";
import { DEFAULT_ACCOUNT_ID } from "maumau/plugin-sdk/setup";
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "maumau pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: MaumauConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: MaumauConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to Maumau",
        order: 90,
      },
      capabilities: {
    ...
    pairing: {
      text: {
        ...
        message: "Maumau: your access has been approved.",
