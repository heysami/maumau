...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.maumau", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Maumau windows, but below the system’s pop-up menus.
