...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: MaumauProtocol.AnyCodable]?
    {
        ...
        return [
            "id": MaumauProtocol.AnyCodable(identity.deviceId),
            "publicKey": MaumauProtocol.AnyCodable(publicKey),
            "signature": MaumauProtocol.AnyCodable(signature),
            "signedAt": MaumauProtocol.AnyCodable(signedAtMs),
            "nonce": MaumauProtocol.AnyCodable(nonce),
        ]
    }
}
