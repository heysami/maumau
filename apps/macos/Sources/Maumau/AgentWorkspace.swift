...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.maumau", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return MaumauConfigFile.defaultWorkspaceURL() }
