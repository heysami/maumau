---
summary: "Maumau tools and plugins overview: what the agent can do and how to extend it"
read_when:
  - You want to understand what tools Maumau provides
...
<Steps>
  ...
  <Step title="Plugins package everything together">
    ...
    Some plugins are **core** (shipped with Maumau), others are **external**
...
These tools ship with Maumau and are available without installing any plugins:
...
| `group:nodes`      | nodes                                                                                                     |
| `group:maumau`     | All built-in Maumau tools (excludes plugin tools)                                                         |
