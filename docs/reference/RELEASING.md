...
Maumau has three public release lanes:
...
- Every Maumau release ships the npm package and macOS app together
...
- Run `RELEASE_TAG=vYYYY.M.D node --import tsx scripts/maumau-npm-release-check.ts`
  (or the matching beta/correction tag) before approval
- After npm publish, run
  `node --import tsx scripts/maumau-npm-postpublish-verify.ts YYYY.M.D`
...
- [`.github/workflows/maumau-npm-release.yml`](https://github.com/maumau/maumau/blob/main/.github/workflows/maumau-npm-release.yml)
- [`scripts/maumau-npm-release-check.ts`](https://github.com/maumau/maumau/blob/main/scripts/maumau-npm-release-check.ts)
- [`scripts/package-mac-dist.sh`](https://github.com/maumau/maumau/blob/main/scripts/package-mac-dist.sh)
- [`scripts/make_appcast.sh`](https://github.com/maumau/maumau/blob/main/scripts/make_appcast.sh)

Maintainers use the private release docs in
[`maumau/maintainers/release/README.md`](https://github.com/maumau/maintainers/blob/main/release/README.md)
