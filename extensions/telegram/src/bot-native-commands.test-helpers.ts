...
import type { ChannelGroupPolicy } from "maumau/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "maumau/plugin-sdk/config-runtime";
import type { RuntimeEnv } from "maumau/plugin-sdk/runtime-env";
...
type GetPluginCommandSpecsFn =
  typeof import("maumau/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("maumau/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("maumau/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("maumau/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("maumau/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("maumau/plugin-sdk/reply-runtime", async (importOriginal) => {
...
vi.mock("maumau/plugin-sdk/conversation-runtime", async (importOriginal) => {
...
vi.mock("maumau/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual = await importOriginal<typeof import("maumau/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as MaumauConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as MaumauConfig),
