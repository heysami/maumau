...
export function resolveTtsConfig(cfg: MaumauConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.MAUMAU_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: MaumauConfig): string | undefined {
...
export function resolveTtsProviderOrder(primary: TtsProvider, cfg?: MaumauConfig): TtsProvider[] {
