...
import { fetchWithSsrFGuard } from "maumau/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to Maumau workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".maumau", "workspace", "media", "inbound");
 ...
 * Format matches Maumau's expected attachment structure.
 */
