...
function resolveAcpStreamCoalesceIdleMs(cfg: MaumauConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: MaumauConfig): number {
...
export function resolveAcpProjectionSettings(cfg: MaumauConfig): AcpProjectionSettings {
