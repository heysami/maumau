...
public struct MaumauChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct MaumauChatSessionsDefaults: Codable, Sendable {
...
public struct MaumauChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct MaumauChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: MaumauChatSessionsDefaults?
    public let sessions: [MaumauChatSessionEntry]
    ...
    public init(
        ...
        sessions: [MaumauChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
