...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("maumau.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("maumau.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: MaumauConfig): Promise<ContextEngine> {
