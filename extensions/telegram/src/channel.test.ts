...
function createCfg(): MaumauConfig {
  return {
    channels: {
      telegram: {
        enabled: true,
...
function resolveAccount(cfg: MaumauConfig, accountId: string): ResolvedTelegramAccount {
  return telegramPlugin.config.resolveAccount(cfg, accountId) as ResolvedTelegramAccount;
}

function createStartTelegramContext(cfg: MaumauConfig, accountId: string) {
...
function startTelegramAccount(cfg: MaumauConfig, accountId: string) {
...
function configureOpsProxyNetwork(cfg: MaumauConfig) {
