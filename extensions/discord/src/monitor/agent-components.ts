...
import { resolveHumanDelayConfig } from "maumau/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "maumau/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "maumau/plugin-sdk/channel-reply-pipeline";
import type { MaumauConfig } from "maumau/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "maumau/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "maumau/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "maumau/plugin-sdk/config-runtime";
import type { DiscordAccountConfig } from "maumau/plugin-sdk/config-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "maumau/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "maumau/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent } from "maumau/plugin-sdk/infra-runtime";
import { getAgentScopedMediaLocalRoots } from "maumau/plugin-sdk/media-runtime";
import {
  dispatchPluginInteractiveHandler,
  type PluginInteractiveDiscordHandlerContext,
} from "maumau/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "maumau/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "maumau/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "maumau/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "maumau/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "maumau/plugin-sdk/routing";
import { logVerbose } from "maumau/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "maumau/plugin-sdk/runtime-env";
import { logDebug, logError } from "maumau/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__maumau_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__maumau_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__maumau_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__maumau_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__maumau_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__maumau_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Maumau form";
  customId = "__maumau_discord_component_modal_wildcard__";
  components = [];
