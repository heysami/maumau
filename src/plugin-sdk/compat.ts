...
const shouldWarnCompatImport =
  ...
  process.env.MAUMAU_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "maumau/plugin-sdk/compat is deprecated for new plugins. Migrate to focused maumau/plugin-sdk/<subpath> imports. See https://docs.maumau.ai/plugins/sdk-migration",
    {
      code: "MAUMAU_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.maumau.ai/plugins/sdk-migration",
    },
  );
}
