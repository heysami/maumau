...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: MaumauConfig): string | undefined {
  ...
  function listAccountIds(cfg: MaumauConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: MaumauConfig): string {
