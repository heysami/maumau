---
summary: "Host Maumau on a DigitalOcean Droplet"
read_when:
  - Setting up Maumau on DigitalOcean
  - Looking for a simple paid VPS for Maumau
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent Maumau Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `maumau doctor --non-interactive` and check logs with `journalctl --user -u maumau-gateway.service -n 50`.
