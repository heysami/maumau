...
const MAUMAU_ATTRIBUTION_PRODUCT = "Maumau";
const MAUMAU_ATTRIBUTION_ORIGINATOR = "maumau";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: MAUMAU_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: MAUMAU_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${MAUMAU_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
