...
import type { MaumauPluginConfigSchema } from "maumau/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): MaumauPluginConfigSchema {
