...
function parseArgs(argv) {
  return parseFlagArgs(
    argv,
    {
      ...
      maxWallMs: readEnvNumber("MAUMAU_TEST_PERF_MAX_WALL_MS"),
      baselineWallMs: readEnvNumber("MAUMAU_TEST_PERF_BASELINE_WALL_MS"),
      maxRegressionPct: readEnvNumber("MAUMAU_TEST_PERF_MAX_REGRESSION_PCT") ?? 10,
    },
    [
