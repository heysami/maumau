...
import type { TelegramNetworkConfig } from "maumau/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "maumau/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "maumau/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "MAUMAU_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "MAUMAU_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "MAUMAU_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable MAUMAU_TELEGRAM_DNS_RESULT_ORDER
