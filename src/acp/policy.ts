...
export function isAcpEnabledByPolicy(cfg: MaumauConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: MaumauConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: MaumauConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: MaumauConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: MaumauConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: MaumauConfig, agentId: string): boolean {
