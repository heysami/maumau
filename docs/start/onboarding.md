---
summary: "First-run setup flow for Maumau (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Maumau">
...
<Step title="CLI">
  ...
  The app can install the global `maumau` CLI via npm/pnpm so terminal
