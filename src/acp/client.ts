...
export async function createAcpClient(opts: AcpClientOptions = {}): Promise<AcpClientHandle> {
  ...
  const defaultServerCommand = entryPath ? process.execPath : "maumau";
  ...
  await client.initialize({
    ...
    clientInfo: { name: "maumau-acp-client", version: "1.0.0" },
  });
