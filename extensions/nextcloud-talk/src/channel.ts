...
} from "maumau/plugin-sdk/channel-pairing";
...
import { runStoppablePassiveMonitor } from "maumau/plugin-sdk/extension-shared";
import {
          ...
          if (changed) {
            if (nextSection && Object.keys(nextSection).length > 0) {
              ...
              if (Object.keys(nextChannels).length > 0) {
                nextCfg.channels = nextChannels as MaumauConfig["channels"];
              } else {
