...
vi.mock("maumau/plugin-sdk/media-runtime", () => ({
...
const TEST_CACHE_DIR = "/tmp/maumau-test-sticker-cache/telegram";
...
describe("sticker-cache", () => {
  beforeEach(async () => {
    process.env.MAUMAU_STATE_DIR = "/tmp/maumau-test-sticker-cache";
    fs.rmSync("/tmp/maumau-test-sticker-cache", { recursive: true, force: true });
