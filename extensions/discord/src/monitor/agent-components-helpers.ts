...
import { resolveCommandAuthorizedFromAuthorizers } from "maumau/plugin-sdk/command-auth";
...
import { upsertChannelPairingRequest } from "maumau/plugin-sdk/conversation-runtime";
...
import { logError } from "maumau/plugin-sdk/text-runtime";
import {
...
export type AgentComponentContext = {
  ...
  runtime?: import("maumau/plugin-sdk/runtime-env").RuntimeEnv;
  token?: string;
