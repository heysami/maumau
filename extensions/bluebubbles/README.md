...
This directory contains the **BlueBubbles external channel plugin** for Maumau.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `maumau/plugin-sdk` helpers.
