...
import { clearHistoryEntriesIfEnabled } from "maumau/plugin-sdk/reply-history";
...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "maumau/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: MaumauConfig, agentId: string) {
  try {
