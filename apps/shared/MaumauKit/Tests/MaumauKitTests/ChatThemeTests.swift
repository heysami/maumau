...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = MaumauChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = MaumauChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
