...
import { createAccountStatusSink } from "maumau/plugin-sdk/channel-lifecycle";
import { createPairingPrefixStripper } from "maumau/plugin-sdk/channel-pairing";
import {
  createEmptyChannelResult,
  createRawChannelSendResultAdapter,
} from "maumau/plugin-sdk/channel-send-result";
import { createStaticReplyToModeResolver } from "maumau/plugin-sdk/conversation-runtime";
...
function resolveZalouserOutboundChunkMode(cfg: MaumauConfig, accountId?: string) {
  return getZalouserRuntime().channel.text.resolveChunkMode(cfg, "zalouser", accountId);
}

function resolveZalouserOutboundTextChunkLimit(cfg: MaumauConfig, accountId?: string) {
