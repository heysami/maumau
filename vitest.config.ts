...
export default defineConfig({
  resolve: {
    // Keep this ordered: the base `maumau/plugin-sdk` alias is a prefix match.
    alias: [
      {
        find: "maumau/extension-api",
        replacement: path.join(repoRoot, "src", "extensionAPI.ts"),
      },
      ...pluginSdkSubpaths.map((subpath) => ({
        find: `maumau/plugin-sdk/${subpath}`,
        replacement: path.join(repoRoot, "src", "plugin-sdk", `${subpath}.ts`),
      })),
      {
        find: "maumau/plugin-sdk",
  ...
  test: {
    ...
    include: [
      ...
      "extensions/**/*.test.ts",
      "test/**/*.test.ts",
      "ui/src/ui/app-render.browser.test.ts",
      "ui/src/ui/app-teams-prompt.browser.test.ts",
      "ui/src/ui/app-chat.test.ts",
      "ui/src/ui/views/agents-utils.test.ts",
      "ui/src/ui/views/dashboard.test.ts",
      "ui/src/ui/views/team-prompt-dialog.test.ts",
      "ui/src/ui/views/teams.test.ts",
      ...
      "ui/src/ui/controllers/mau-office.test.ts",
      "ui/src/ui/controllers/multi-user-memory.test.ts",
      "ui/src/ui/controllers/dashboard.test.ts",
