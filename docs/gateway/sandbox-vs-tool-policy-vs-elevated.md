...
Maumau has three related (but different) controls:
...
Use the inspector to see what Maumau is _actually_ doing:
...
- `group:nodes`: `nodes`
- `group:maumau`: all built-in Maumau tools (excludes provider plugins)
