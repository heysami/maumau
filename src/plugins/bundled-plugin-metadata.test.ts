...
describe("bundled plugin metadata", () => {
  ...
  it("prefers built generated paths when present and falls back to source paths", () => {
    const tempRoot = createGeneratedPluginTempRoot("maumau-bundled-plugin-metadata-");
  ...
  it("supports check mode for stale generated artifacts", () => {
    const tempRoot = createGeneratedPluginTempRoot("maumau-bundled-plugin-generated-");
    ...
    writeJson(path.join(tempRoot, "extensions", "alpha", "maumau.plugin.json"), {
      id: "alpha",
