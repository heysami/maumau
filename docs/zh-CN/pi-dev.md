...
本指南总结了在 Maumau 中开发 Pi 集成的合理工作流程。
...
状态存储在 Maumau 状态目录下。默认为 `~/.maumau`。如果设置了 `MAUMAU_STATE_DIR`，则使用该目录。
...
- https://docs.maumau.ai/testing
- https://docs.maumau.ai/start/getting-started
