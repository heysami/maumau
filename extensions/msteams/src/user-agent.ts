...
function resolveMaumauVersion(): string {
  try {
 ...
 * and appends the Maumau version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Maumau/<maumau-version>"
 * Example: "teams.ts[apps]/2.0.5 Maumau/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Maumau/${resolveMaumauVersion()}`;
  return cachedUserAgent;
}
