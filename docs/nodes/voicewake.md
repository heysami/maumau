...
Maumau treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.maumau/settings/voicewake.json`

Shape:

```json
{ "triggers": ["maumau", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
