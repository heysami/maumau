...
import type { MaumauPluginApi, MaumauPluginConfigSchema } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  description: string;
  plugin: TPlugin;
  configSchema?: MaumauPluginConfigSchema | (() => MaumauPluginConfigSchema);
  setRuntime?: (runtime: PluginRuntime) => void;
  registerFull?: (api: MaumauPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: MaumauConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
