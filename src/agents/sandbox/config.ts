...
const DEFAULT_SANDBOX_SSH_WORKSPACE_ROOT = "/tmp/maumau-sandboxes";
...
export function resolveSandboxConfigForAgent(cfg?: MaumauConfig, agentId?: string): SandboxConfig {
