...
- MAUMAU_GATEWAY_VERSION = exact package.json version
- MAUMAU_MARKETING_VERSION = short iOS/App Store version
- MAUMAU_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
MAUMAU_GATEWAY_VERSION = ${PACKAGE_VERSION}
MAUMAU_MARKETING_VERSION = ${MARKETING_VERSION}
MAUMAU_BUILD_VERSION = ${BUILD_NUMBER}
EOF
