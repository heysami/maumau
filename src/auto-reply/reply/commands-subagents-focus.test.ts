...
function createMatrixThreadCommandParams(commandBody: string, cfg: MaumauConfig = baseCfg) {
...
function createMatrixRoomCommandParams(commandBody: string, cfg: MaumauConfig = baseCfg) {
  const params = buildCommandTestParams(commandBody, cfg, {
    Provider: "matrix",
    Surface: "matrix",
    OriginatingChannel: "matrix",
