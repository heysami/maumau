...
const PLUGIN_INTERACTIVE_STATE_KEY = Symbol.for("maumau.pluginInteractiveState");
...
const getState = () =>
  resolveGlobalSingleton<InteractiveState>(PLUGIN_INTERACTIVE_STATE_KEY, () => ({
    ...
    callbackDedupe: resolveGlobalDedupeCache(Symbol.for("maumau.pluginInteractiveCallbackDedupe"), {
      ttlMs: 5 * 60_000,
      maxSize: 4096,
    }),
  }));
